...
export default class PhysicsEngine {
  ...
  addParticles(particles) { this.particles = this.particles.concat(particles); }
  addSpring(s) { this.springs.push(s); }
  addSprings(springs) { this.springs = this.springs.concat(springs); }
